...
export function HeroSection({ data, translations: tr }: Props) {
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute left-0 bottom-0 h-[400px] w-[400px] translate-y-1/3 -translate-x-1/3 rounded-full bg-purple/10 blur-[120px]" />

      <div className="container mx-auto px-4 py-12 sm:py-16 lg:px-8 lg:py-24">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-12">
          <div className="max-w-xl text-center lg:text-left mx-auto lg:mx-0">
            <h1 className="text-balance text-3xl font-bold leading-tight tracking-tight text-offwhite sm:text-4xl md:text-5xl lg:text-6xl">
              {title}{" "}
              <span className="text-gold">{titleHighlight}</span>
            </h1>
            <p className="mt-5 text-pretty text-base leading-relaxed text-sage sm:text-lg">
              {description}
            </p>
